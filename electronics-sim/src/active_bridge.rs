...
impl ActiveBridgeSim {
    ...
    pub fn tick(
        ...
        let d = [
            duties[0].clamp(0.0, 1.0),
            duties[1].clamp(0.0, 1.0),
            duties[2].clamp(0.0, 1.0),
        ];
        ...
        for phase in 0..3 {
            ...
            // P = v_conv × i_avg = duty × V_dc × i_avg
            // Charge = P × t_sw / V_dc = duty × i_avg × t_sw
            q_dc_total += duty * i_avg * self.t_sw;
