...
const HRTIM_AF: &[AfOption] = &[
    ...
    //
    // Generated from stm32-metapac 19.0.0 G474RE (LQFP64) peripheral pin
    // metadata. Marked ALL_V for now; per-package (G474C/M/P/Q/V)
    // refinement still needed — some PD*/PE*/PF*/PG* entries don't
    // physically exist on LQFP48. Pin availability on the default
    // rendered package (LQFP64) is correct.
    //
    // Deduplicated: USART DE aliases RTS pin; SPI I2S_* aliases skipped;
    // UCPD DBCCx / FRSTXx skipped (not in Signal enum yet).
    // FDCAN1
    ...
    af!('C',  8,  8, Signal::I2cScl(I2cId::I2c3), ALL_V),
    af!('C',  9,  8, Signal::I2cSda(I2cId::I2c3), ALL_V),
    // I2C4
    ...
    af!('C',  7,  8, Signal::I2cSda(I2cId::I2c4), ALL_V),
    // LPUART1
    ...
    af!('C',  0,  8, Signal::LpuartRx(LpuartId::Lpuart1), ALL_V),
    af!('C',  1,  8, Signal::LpuartTx(LpuartId::Lpuart1), ALL_V),
    // SPI1
    ...
    af!('C', 12,  6, Signal::SpiMosi(SpiId::Spi3), ALL_V),
    // TIM1
    ...
    af!('C',  0,  2, Signal::TimCh(TimId::Tim1, TimCh::Ch1), ALL_V),
    af!('C',  1,  2, Signal::TimCh(TimId::Tim1, TimCh::Ch2), ALL_V),
    af!('C', 13,  2, Signal::TimBkin(TimId::Tim1), ALL_V),
    af!('C', 13,  4, Signal::TimChN(TimId::Tim1, TimCh::Ch1), ALL_V),
    af!('C',  2,  2, Signal::TimCh(TimId::Tim1, TimCh::Ch3), ALL_V),
    af!('C',  3,  6, Signal::TimBkin2(TimId::Tim1), ALL_V),
    af!('C',  3,  2, Signal::TimCh(TimId::Tim1, TimCh::Ch4), ALL_V),
    af!('C',  4,  2, Signal::TimEtr(TimId::Tim1), ALL_V),
    af!('C',  5,  6, Signal::TimChN(TimId::Tim1, TimCh::Ch4), ALL_V),
    ...
    af!('C',  5,  2, Signal::TimBkin(TimId::Tim15), ALL_V),
    // TIM16
    ...
    af!('C',  2,  6, Signal::TimCh(TimId::Tim20, TimCh::Ch2), ALL_V),
    af!('C',  8,  6, Signal::TimCh(TimId::Tim20, TimCh::Ch3), ALL_V),
    // TIM3
    ...
    af!('C',  7,  2, Signal::TimCh(TimId::Tim3, TimCh::Ch2), ALL_V),
    af!('C',  8,  2, Signal::TimCh(TimId::Tim3, TimCh::Ch3), ALL_V),
    af!('C',  9,  2, Signal::TimCh(TimId::Tim3, TimCh::Ch4), ALL_V),
    af!('D',  2,  2, Signal::TimEtr(TimId::Tim3), ALL_V),
    // TIM4
    ...
    af!('C', 12,  1, Signal::TimCh(TimId::Tim5, TimCh::Ch2), ALL_V),
    // TIM8
    ...
    af!('C', 12,  4, Signal::TimChN(TimId::Tim8, TimCh::Ch3), ALL_V),
    af!('C', 13,  6, Signal::TimChN(TimId::Tim8, TimCh::Ch4), ALL_V),
    af!('C',  6,  4, Signal::TimCh(TimId::Tim8, TimCh::Ch1), ALL_V),
    af!('C',  7,  4, Signal::TimCh(TimId::Tim8, TimCh::Ch2), ALL_V),
    af!('C',  8,  4, Signal::TimCh(TimId::Tim8, TimCh::Ch3), ALL_V),
    af!('C',  9,  6, Signal::TimBkin2(TimId::Tim8), ALL_V),
    af!('C',  9,  4, Signal::TimCh(TimId::Tim8, TimCh::Ch4), ALL_V),
    af!('D',  2,  4, Signal::TimBkin(TimId::Tim8), ALL_V),
    // UART4
    ...
    // UART5
    af!('B',  4,  8, Signal::UartRts(UartId::Uart5), ALL_V),
    af!('B',  5, 14, Signal::UartCts(UartId::Uart5), ALL_V),
    af!('C', 12,  5, Signal::UartTx(UartId::Uart5), ALL_V),
    af!('D',  2,  5, Signal::UartRx(UartId::Uart5), ALL_V),
    // UCPD1
    ...
    af!('C',  5,  7, Signal::UsartRx(UsartId::Usart1), ALL_V),
    // USART2
    ...
    af!('C', 12,  7, Signal::UsartCk(UsartId::Usart3), ALL_V),
    // USB
